...
\restrict gd4xHqQGDSddE6VXFnhXVpiuf2GvCrf1SYufMgsBbt6tARkCSZJzsB1kaVb5KP1
...
SELECT pg_catalog.setval('public.editor_changeset_id_seq', 22, true);
...
SELECT pg_catalog.setval('public.editor_changesetupdate_id_seq', 213, true);
...
SELECT pg_catalog.setval('public.mapdata_area_groups_id_seq', 120, true);
...
SELECT pg_catalog.setval('public.mapdata_locationslug_id_seq', 186, true);
...
SELECT pg_catalog.setval('public.mapdata_mapupdate_id_seq', 2098, true);
...
\unrestrict gd4xHqQGDSddE6VXFnhXVpiuf2GvCrf1SYufMgsBbt6tARkCSZJzsB1kaVb5KP1
