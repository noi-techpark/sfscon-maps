...
\restrict M6o5n8Zk5echjNl3eciDwKWO5LXUFvW2NjJcrdPMdIfgJQCYHH8L766Wm6dkFh3
...
SELECT pg_catalog.setval('public.editor_changeset_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.editor_changesetupdate_id_seq', 52, true);
...
SELECT pg_catalog.setval('public.mapdata_area_groups_id_seq', 59, true);
...
SELECT pg_catalog.setval('public.mapdata_locationslug_id_seq', 159, true);
...
SELECT pg_catalog.setval('public.mapdata_mapupdate_id_seq', 1833, true);
...
SELECT pg_catalog.setval('public.mapdata_poi_groups_id_seq', 125, true);
...
\unrestrict M6o5n8Zk5echjNl3eciDwKWO5LXUFvW2NjJcrdPMdIfgJQCYHH8L766Wm6dkFh3
