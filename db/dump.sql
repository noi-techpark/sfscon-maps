...
\restrict mDXIaVwYOgjo3tLRMEuHnLTKp66ja3KL6gVBuxVzJeoXj8LcJATSEJv2bGWn8nm
...
SELECT pg_catalog.setval('public.editor_changeset_id_seq', 23, true);
...
SELECT pg_catalog.setval('public.editor_changesetupdate_id_seq', 218, true);
...
SELECT pg_catalog.setval('public.mapdata_graphedge_id_seq', 772, true);
...
SELECT pg_catalog.setval('public.mapdata_graphnode_id_seq', 283, true);
...
SELECT pg_catalog.setval('public.mapdata_mapupdate_id_seq', 2101, true);
...
\unrestrict mDXIaVwYOgjo3tLRMEuHnLTKp66ja3KL6gVBuxVzJeoXj8LcJATSEJv2bGWn8nm
